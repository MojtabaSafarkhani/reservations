...
Route::get('/hotels/showNew/{hotel}', [HomeController::class, 'showNew'])->name('client.hotel.showNew');
...
Route::get('/show-all-category/{category}', [HomeController::class, 'categoryShowAll'])->name('category.show.all');
Route::get('/show-all-city/{city}', [HomeController::class, 'cityShowAll'])->name('city.show.all');
